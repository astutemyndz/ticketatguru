...
(function ($, undefined) {
    $(function () {
            ...
            $frmUpdateShow.validate({
                ...
                submitHandler: function (form) {
                    ...
                    function setBeforeSave(i) {
                        $.post("admin.php?controller=pjAdminEvents&action=pjActionBeforeSave", post_arr[i], callback);
                    }
                    function callback(data) {
                        ...
                        if (loop < post_arr.length) {
                            ...
                            $.post("admin.php?controller=pjAdminEvents&action=pjActionSave").done(function (data) {
                                ...
                                if (data.code == '101') {
                                    ...
                                    $dialogShowStatus.dialog("option", "close", function () {
                                        ...
                                        if (data.code == '200') {
                                            window.location.href = "admin.php?controller=pjAdminEvents&action=pjActionShow&id=" + data.id + "&err=" + data.text;
                                        }
                                    });
                                    $dialogShowStatus.dialog("option", "buttons", {
                                        'Close': function () {
            ...
            $dialogDeleteShow.dialog({
                ...
                buttons: (function () {
                    ...
                    buttons[tbApp.locale.button.delete] = function () {
                        ...
                        $.post("admin.php?controller=pjAdminEvents&action=pjActionDeleteShow", {
                            "id": id
                        }).done(function (data) {
        ...
        function formatImage(str, obj) {
            ...
            return ['<a href="admin.php?controller=pjAdminEvents&action=pjActionUpdate&id=', obj.id, '"><img src="', src, '" style="width: 80px; display:block;" /></a>'].join("");
        }
        if ($("#grid").length > 0 && datagrid) {

            var $grid = $("#grid").datagrid({
                buttons: [{ type: "edit", url: "admin.php?controller=pjAdminEvents&action=pjActionUpdate&id={:id}" },
                { type: "delete", url: "admin.php?controller=pjAdminEvents&action=pjActionDeleteEvent&id={:id}", beforeShow: onBeforeShow },
                {
                    type: "menu", url: "#", text: '', items: [
                        { text: myLabel.showtimes, url: "admin.php?controller=pjAdminEvents&action=pjActionShow&id={:id}" },
                        { text: myLabel.bookings, url: "admin.php?controller=pjAdminEvents&action=pjActionBooking&id={:id}" }
                    ]
                }
                ],
                ...
                dataUrl: "admin.php?controller=pjAdminEvents&action=pjActionGetEvent",
                dataType: "json",
                fields: ['event_img', 'title', 'duration', 'status'],
                paginator: {
                    actions: [
                        { text: myLabel.delete_selected, url: "admin.php?controller=pjAdminEvents&action=pjActionDeleteEventBulk", render: true, confirmation: myLabel.delete_confirmation },
                        { text: myLabel.revert_status, url: "admin.php?controller=pjAdminEvents&action=pjActionStatusEvent", render: true },
                        { text: myLabel.exported, url: "admin.php?controller=pjAdminEvents&action=pjActionExportEvent", ajax: false }
                    ],
                    gotoPage: true,
                    paginate: true,
                    total: true,
                ...
                saveUrl: "admin.php?controller=pjAdminEvents&action=pjActionSaveEvent&id={:id}",
                select: {
                    field: "id",
                    name: "record[]"
                }
        ...
        function getSeats(index) {
            ...
            $.get("admin.php?controller=pjAdminEvents&action=pjActionGetSeats&event_id=" + event_id + "&venue_id=" + venue_id + "&date_time=" + date_time + "&index=" + index).done(function (data) {
        ...
        $(document).on("click", ".btn-all", function (e) {
            ...
            $grid.datagrid("load", "admin.php?controller=pjAdminEvents&action=pjActionGetEvent", "created", "DESC", content.page, content.rowCount);
            return false;
            ...
            $.post("admin.php?controller=pjAdminEvents&action=pjActionSetActive", {
                id: $(this).closest("tr").data("object")['id']
            }).done(function (data) {
                $grid.datagrid("load", "admin.php?controller=pjAdminEvents&action=pjActionGetEvent");
            });
            return false;
            ...
            if (date_time != '') {
                ...
                $.post("admin.php?controller=pjAdminEvents&action=pjActionAddShow&event_id=" + event_id + "&period=" + $(this).attr('data-period'), post_data).done(function (data) {
        ...
        $('#btnAddClients').click(() => {
            window.location = '/projects/booking/admin.php?controller=pjAdminClients&action=pjActionCreate';
        });
