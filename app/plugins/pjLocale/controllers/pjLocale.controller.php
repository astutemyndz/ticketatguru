...
class pjLocale extends pjLocaleAppController
{
	...
	public function pjActionSaveFields()
	{
		...
		pjUtil::redirect(sprintf("%sadmin.php?controller=pjLocale&action=%s&err=PAL01&tab=1&q=%s&locale=%u&page=%u", PJ_INSTALL_URL, $_POST['next_action'], urlencode($_POST['q']), $_POST['locale'], $_POST['page']));
		exit;
	}
	...
	public function pjActionImportConfirm()
	{
		...
		if (isset($_POST['import']))
		{
			...
			pjUtil::redirect(PJ_INSTALL_URL . "admin.php?controller=pjLocale&action=pjActionImportConfirm&tab=1&err=".$err);
		}
	...
	public function pjActionImport()
	{
		...
		pjUtil::redirect(PJ_INSTALL_URL . "admin.php?controller=pjLocale&action=pjActionImportExport&tab=1&err=".$err);
	}
