...
<div class="leftmenu-middle">
	<ul class="menu">
		...
		if ($controller->isAdmin())
		{
			...
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminVideo&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminVideo' ? 'menu-focus' : NULL; ?>"><span class="menu-events">&nbsp;</span><?php __('menuVideo'); ?></a></li>
