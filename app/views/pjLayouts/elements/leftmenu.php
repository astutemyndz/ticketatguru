...
<div class="leftmenu-middle">
	<ul class="menu">
		...
		<!--<li class="dropdown">
			<a href="javascript:;" onclick="myFunction()" class="dropbtn"><span class="menu-schedule">&nbsp;</span> DropDown <i class="fa fa-angle-down" aria-hidden="true"></i></a>
			<ul id="myDropdown" class="dropdown-content">
				<li><a href="#"><span class="menu-schedule">&nbsp;</span> DropDown2</a></li>
			</ul>
		</li>-->
