...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminImageGallery&amp;action=pjActionIndex"><?php __('menuItemList'); ?></a></li>
		</ul>
	</div>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminImageGallery&amp;action=pjActionCreate" method="post" id="frmCreateImageGallery" class="pj-form form" enctype="multipart/form-data">
		<input type="hidden" name="image_gallery_create" value="1" />
		...
		<?php
			...
			<p>
				...
				<span class="inline_block">
					<input type="file" name="gallery_image" id="gallery_image" class="pj-form-field w250 required" />
				</span>
			</p>
