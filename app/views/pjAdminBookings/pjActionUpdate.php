			...
			<div id="tabs-1" class="pj-loader-outer">
				...
				<p>
					...
					<span class="inline-block">
						<input type="text" name="uuid" id="uuid" class="pj-form-field w1500 required" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['uuid'])); ?>"/>
					</span>
				</p>
				<p>
					...
					<span class="inline-block">
						<select name="event_id" id="event_id" class="pj-form-field w300 required">
							...
							{
								?><option value="<?php echo $v['id']; ?>"<?php echo $tpl['arr']['event_id'] == $v['id'] ? ' selected="selected"' : null;?>><?php echo stripslashes($v['title']); ?></option><?php
							}
							?>
						</select>
					</span>
