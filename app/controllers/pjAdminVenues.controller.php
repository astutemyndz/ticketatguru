...
class pjAdminVenues extends pjAdmin
{
	...
	public function pjActionCreate()
	{
		...
		if ($this->isAdmin() || $this->isEditor())
		{
			...
			{
				pjUtil::redirect(PJ_INSTALL_URL . "admin.php?controller=pjAdminVenues&action=pjActionIndex&err=AV05");
			}
	...
	public function pjActionUpdate()
	{
		...
		if ($this->isAdmin() || $this->isEditor())
		{
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SERVER['CONTENT_LENGTH']) && (int) $_SERVER['CONTENT_LENGTH'] > $post_max_size)
			{
				pjUtil::redirect(PJ_INSTALL_URL . "admin.php?controller=pjAdminVenues&action=pjActionIndex&err=AV06");
			}	
